...
const CaseStudiesData = [
  {
    ...
    result:
      "30% faster checkout process, 99.9% uptime, $2M GMV in first quarter.",
    image:
      "https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=400&q=80",
  },
  {
    id: 2,
    ...
    result:
      "95% accuracy in predictions, 5x faster data processing, 200+ enterprise clients.",
    image:
...
export default function CaseStudyPage() {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative w-full min-h-screen ${bgClass}`}
    >
          ...
          <div className="relative w-full max-w-5xl h-[450px] flex items-center justify-center">
            {CaseStudiesData.map((project, i) => {
              ...
              const scale = useTransform(
                scrollYProgress,
                [0, 1],
                [1 - (total - i - 1) * 0.05, 1 - (total - i - 1) * 0.05]
              );
                  ...
                  <div className="flex flex-col sm:flex-row items-center h-full gap-8">
                    ...
                    <div className="sm:w-1/2 flex flex-col justify-center">
                      ...
                      <div className="mt-15 flex justify-center">
                        {/* newly added link element above button element */}
                        <Link
                          to={`/case-studies/${project.title
                            .toLowerCase()
                            .replace(/\s+/g, "-")}`}
                        >
                          <button
